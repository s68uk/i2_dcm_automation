...
# Tried and confirmed BLOCKED 27 Aug 2026 — all three are Next.js apps whose
# article listings are fetched client-side after page load (no data in the
# initial HTML, confirmed via __NEXT_DATA__ inspection). Same category of
# problem as Houlihan Lokey/Reuters: needs a browser-based fetch, not a
# selector fix.
#   - Linklaters (linklaters.com/en/about-us/news-and-deals)
#   - A&O Shearman (aoshearman.com/en/newsroom)
#   - Kroll (kroll.com/en/insights)
