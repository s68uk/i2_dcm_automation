...
"""
PACKAGE: 5
Last updated: 27 Aug 2026 — label changed from "Why it matters to i2" to
"Relevance" (shorter, no redundant "to i2" since the report is already
titled "i2 Capital Markets").
